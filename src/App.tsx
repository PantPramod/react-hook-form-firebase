...
function App() {
  ...
  const handleResumeValidate = (resume: { type: string, name: string, size: number }[]) => {
    console.log(resume)
    if (resume[0].type == "application/pdf" && resume[0].size < 5000000) {
      return true
    } else {
      return false
    }
  ...
  return (<>
    ...
    <div className="app">
      ...
      <form onSubmit={handleSubmit((data) => {
        ...
        writeHandler({ fullName: data.fullName, email: data.email, resume: resumeUrl, company: data.company, phone: data.phone, link: data.link, info: data.info, gender: data.gender });
        ...
        <div className='input'>
          <div className='input-box'>
            ...
            <div className='field-error'>
              <div id='phoneNumber'>
                <input type="number" id="cc" {...register("cC", { required: "Enter country code", minLength: 2 })} />
